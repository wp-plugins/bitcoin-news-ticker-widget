...
DEFINE("BITCOIN_NEWS_URL","http://99bitcoins.com/blogpost_feed.php");
...
<div class="bitcoin_news_container">
        	...
        	<div class="widget_frame">
				...
				<?php 
					...
					for ( $counter = 0; $counter < count($bitcoin_news_data) - 1; $counter++ ) {
						...
						$news_domain = parse_url($bitcoin_news_data[$counter]['url'][0]);
				...
				?>
                	...
                	<div class="news_container">
                    	...
                    	<h1><a rel="nofollow" target="_blank" href="<?php echo $bitcoin_news_data[$counter]['url'][0];?>"><?php echo $bitcoin_news_data[$counter]['title'];?></a></h1>

                        <div class="author" title="<?php echo $site_domain; ?>"><?php echo $display_domain;?></div>

                        <div class="date"><?php echo date("M d", $bitcoin_news_data[$counter]['timestamp']);?></div>
